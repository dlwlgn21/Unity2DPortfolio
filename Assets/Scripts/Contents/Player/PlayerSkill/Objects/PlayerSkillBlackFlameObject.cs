...
public class PlayerSkillBlackFlameObject : MonoBehaviour
{
    ...
    public void CastBlackFlame(Vector2 pos, ECharacterLookDir eLookDir)
    {
        ...
        _animator.Play("BlackFlame", -1, 0f);
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            collision.gameObject.GetComponent<BaseMonsterController>()?.OnHittedByPlayerSkill(Managers.Data.SkillInfoDict[(int)ESkillType.Cast_BlackFlame]);
        }
    }
}
